...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-16 border-t border-white/5 shadow-[0_-5px_30px_rgba(59,130,246,0.15)] relative overflow-hidden">
      {/* Glow Effect */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="inline-block group">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-4 group-hover:from-blue-300 group-hover:to-purple-300 transition-all">
                YourWebPartner
              </h3>
            </Link>

  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      <button
        ...
        className={`relative bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 ${isOpen ? 'rotate-180' : ''}`}
      >
        {isOpen ? (

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-20">
          ...
          <p className="text-2xl text-gray-600 max-w-4xl mx-auto animate-slide-in-up animation-delay-300">
            ...
            <span className="text-purple-600 font-semibold"> thrive online</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-r ${service.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-700 rounded-3xl`}></div>
              ...
              <div className="relative z-10">
                ...
                <div className={`transform transition-all duration-500 ${hoveredIndex === index ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
